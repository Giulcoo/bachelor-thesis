...
\wichtig{Idee zum minimieren von schreib Prozessen im Speicher während gespielt wird: Eine Datei, in der alle Veränderten Objekte gespeichert werden, indem diese am Ende der Datei immer hinzugefügt werden. Beim beenden des Spieles oder beim wieder neu starten wird diese Datei abgearbeitet und geleert}
%--------------------------------------------------------------------------
