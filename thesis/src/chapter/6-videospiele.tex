...
\begin{figure}[htp]
    \centering
    \begin{tikzpicture}
        \pie{29.6/Decoratives,
            23.7/Tiles,
            15.3/Entities,
            9.6/Blueprint library,
            9.4/Force data,
            5/Transport belts,
            4.1/Surface \& Chunk date,
            3.3/Other
        }    
    \end{tikzpicture}
    \caption{Anteil der Datentypen beim Speichern\cite{factorioFridayFacts270}}
