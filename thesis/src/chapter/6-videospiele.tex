...
\begin{enumerate}
    \item \wichtig{RE-LOGIC: support@re-logic.com oder media@re-logic.com (Terraria)}
    ...
    \item \wichtig{Frontier: press@frontier.co.uk (Rollercoaster Tycoon)}
    \item \wichtig{Paradox Interactive: \url{https://support.paradoxplaza.com/hc/en-us/articles/360002290474-I-emailed-support-paradoxplaza-com-and-no-one-replied-} (Stelaris)}
    \item Studio Wildcard: \url{http://www.studiowildcard.com/contact} (Ark: Survival Evolved)
    \item \wichtig{Minecraft: \url{https://help.minecraft.net/hc/en-us/request/new?ticket_form_id=360001225811}}
