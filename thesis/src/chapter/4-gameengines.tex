...
\begin{figure}[htp]
    ...
    \caption{Laufzeiten der unterschiedlichen \ac{json}-Bibliotheken für Unity \cite{jacksondunstanJacksonDunstancomJSON}}
...
\begin{listing}[htp]
    ...
    \end{minted}
    \caption{Serialisieren und Deserialisieren mit FJsonSerializer in Unreal Engine}
