...
Eine Game Engine ist ein komplexes Software-Framework, das für die Erstellung, Entwicklung und Bereitstellung interaktiver digitaler Erlebnisse konzipiert ist, vor allem für Videospiele, aber auch für Simulationen, Architekturvisualisierungen und vieles mehr.
...
\end{itemize}
% 10.7.
\url{https://docs.unrealengine.com/5.2/en-US/BlueprintAPI/Json/}
