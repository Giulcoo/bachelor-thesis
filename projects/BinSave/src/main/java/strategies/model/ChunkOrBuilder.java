...
public interface ChunkOrBuilder extends
   ...
   */
  java.util.List<strategies.model.Player> 
      getPlayersList();
  /**
   * <code>repeated .strategies.Player players = 2;</code>
   */
  strategies.model.Player getPlayers(int index);
  /**
   * <code>repeated .strategies.Player players = 2;</code>
   */
  int getPlayersCount();
   ...
   * <code>repeated .strategies.Player players = 2;</code>
   */
  java.util.List<? extends strategies.model.PlayerOrBuilder> 
      getPlayersOrBuilderList();
  /**
   * <code>repeated .strategies.Player players = 2;</code>
   */
  strategies.model.PlayerOrBuilder getPlayersOrBuilder(
      int index);
